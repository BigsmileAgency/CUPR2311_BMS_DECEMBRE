<?php
	...
	class WeboramaHeaderGSAPTemplate extends Template {

		public function __construct(){
			parent::__construct(AppPath::getPath()."/template/predefined/weborama/header/assets/index.php");
			$this -> _extImport = "";

			if(GSAPEngine::getVersion() === '1.18.0' && self::sharedLibraries()){
	...
	} else if(GSAPEngine::getVersion() === '1.19.0' && self::sharedLibraries()){
