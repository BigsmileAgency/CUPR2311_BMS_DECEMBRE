<?php
	...
	class WeboramaInterscrollerGSAPTemplate extends Template {

		public function __construct(){
			parent::__construct(AppPath::getPath()."/template/predefined/weborama/interscroller/assets/index.php");
			$this -> _extImport = "";
