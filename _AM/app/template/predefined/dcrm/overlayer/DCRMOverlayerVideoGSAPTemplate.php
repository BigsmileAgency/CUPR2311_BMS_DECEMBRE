<?php 
	...
	class DCRMOverlayerVideoGSAPTemplate extends Template {
				
		public function __construct(){
			parent::__construct(AppPath::getPath()."/template/predefined/dcrm/overlayer/assets/index.php");
			
			//$this -> _assets_scheme = array(new Asset('script', AppPath::getPath()."/template/predefined/dcrm/overlayer/assets/script.js", AssetType::JS));
