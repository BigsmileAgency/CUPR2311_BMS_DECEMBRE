<?php 
	...
	class AdFormGSAPTemplate extends Template {
				
		public function __construct(){
			parent::__construct(AppPath::getPath()."/template/predefined/adform/standard/assets/index.php");

			$this -> _assets_scheme = array(new Asset('manifest', AppPath::getPath()."/template/predefined/adform/standard/assets/manifest.json", AssetType::JSON));
