<?php
	...
	class DCRMDYNAMICProject extends Project {
		...
		public function __construct(Campaign &$pCampaign, AnimationManager &$pAm, &$pInDexVersion, &$pCSSVersion, $default_css = null, $default_js = null){
			$template = TemplateFactory::get("dcrm-dynamic");
		...
		public function apply(){
			...
			if(!Template::cdnLibraries()){
        $this -> _template -> add($this -> _template -> getAssetsScheme($pos));
      }
