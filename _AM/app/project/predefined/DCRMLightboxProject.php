<?php
	...
	class DCRMLightboxProject extends Project {
		...
		public function __construct(Campaign &$pCampaign, AnimationManager &$pAm, &$pInDexVersion, &$pCSSVersion, $default_css = null, $default_js = null){
			$template = TemplateFactory::get("dcrm-lightbox");
			...
			$this -> _folder = 'dcrm-lightbox';

		}
	
		public function attachLightBox(AnimationManager &$pAm){
			$this -> _lb = $pAm;
		}
		...
		public function apply(){
			...
			$enginegsapexp = new GSAPEngine($this -> _lb , new GSAPFormatEngine(), NULL, "expand");
