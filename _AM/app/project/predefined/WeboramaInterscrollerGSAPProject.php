<?php
	...
	class WeboramaInterscrollerGSAPProject extends Project {

		public $deviceDrivenWallpaper = true;
		public $bgSmallPortrait = '';
		public $bgSmallLandscape = '';
		public $bgMediumPortrait = '';
		public $bgMediumLandscape = '';
		public $bgLarge = '';
		...
		public function __construct(Campaign &$pCampaign, AnimationManager &$pAm, &$pInDexVersion, &$pCSSVersion, $default_css = null, $default_js = null){
			$template = TemplateFactory::get("weborama-interscroller");
			...
			$this -> _folder = 'weborama-interscroller';
      ...
      $udata['devMode'] =  $this -> _dev_mode;
			...
			$udata['deviceDrivenWallpaper'] =  $this -> deviceDrivenWallpaper;
			$udata['bgSmallPortrait'] =  $this -> bgSmallPortrait;
			$udata['bgSmallLandscape'] =  $this -> bgSmallLandscape;
			$udata['bgMediumPortrait'] =  $this -> bgMediumPortrait;
			$udata['bgMediumLandscape'] =  $this -> bgMediumLandscape;
			$udata['bgLarge'] =  $this -> bgLarge;


			// $this -> _template -> add(new Asset('billboard', AppPath::getPath()."/template/predefined/weborama/billboard/assets/billboard_970x250.js", AssetType::JS));
