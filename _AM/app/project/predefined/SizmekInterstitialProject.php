<?php
	...
	class SizmekInterstitialProject extends Project {

		protected $_close_text = "X";
		protected $_auto_collapse = 8000;
		...
		public function __construct(Campaign &$pCampaign, AnimationManager &$pAm, &$pInDexVersion, &$pCSSVersion, $default_css = null, $default_js = null){
			$template = TemplateFactory::get("sizmek-interstitial");
			...
			$this -> _folder = 'sizmek-interstitial';
		...
		public function autoCollapse($time){
			$this -> _auto_collapse = intval($time);
		}
		...
		public function apply(){
			...
			$p3 -> replace("auto_collapse",$this -> _auto_collapse);
